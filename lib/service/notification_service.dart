...
class NotificationsService {
  static const key =
      'AAAAwDAOh1k:APA91bHDal6T9GUfjyr4rWZeYLB2EU0n91BAE3fBwIg-elcHNhAE1MxmRkYN9LkmYDzAWc483i3xDKSYYxm8uhT8EGw5poH6zXjF4WNuxdc1jZvFJv5D8MghTc6NUgwmMw0VSOKlqAe2';
  ...
  void firebaseNotification(context) {
    ...
    FirebaseMessaging.onMessageOpenedApp
      ...
      await Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) =>
              FirebaseChatPage(userId: message.data['senderId']),
        ),
      );
    });
